            ...
            </svg>
            {
                ...
                vaultData.map((category, index) => {
                    if (index == selectedCategory - 1) {
                        return (
                            category.entries.map((password_items) => {
                                if (selectedPassword == password_items.password_id) {
                                    return (
                                        <form className=" mt-14 mb-20">
                                            ...
                                            <input className="rounded-lg ml-10 ring-2" type="text" name="title" placeholder="Enter a Title" value={password_items.title} /><br />
                                            <label className="hover:text-gray-600 ml-12 " for="uname"><b>USERNAME</b></label>
                                            <input className="rounded-lg ml-10 mt-5 ring-2" type="text" name="uname" placeholder="Enter a username" value={password_items.username} /><br />
                                            <label className="hover:text-gray-600 ml-12 " for="pword"><b>PASSWORD</b></label>
                                            <input className="rounded-lg ml-10 mt-5 ring-2" type="text" name="pword" placeholder="Enter password" value={password_items.password} />
                                        </form>
                                    )
                                }
                            })
